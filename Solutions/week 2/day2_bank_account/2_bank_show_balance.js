...
Create functionality in order for the user to see his funds.


Challenge1: Instead of using a for loop, use the forEach method.
Challenge2: Use the filter method.
*/
